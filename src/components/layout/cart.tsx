...
import { X, ShoppingBag, Trash2, MapPin, CreditCard, ArrowLeft, Plus, Minus, Star } from 'lucide-react'
    ...
    try {
      const orderData: Order = {
        line_items: items.map(item => ({
          ...
          grams: "0", // Assumindo que não temos o peso, você pode ajustar isso se necessário
          quantity: item.quantity,
          tax_lines: [] // Assumindo que não estamos lidando com impostos neste momento
        })),
        transactions: [{
          kind: "sale",
          status: "success",
        ...
        total_tax: 0, // Assumindo que não estamos lidando com impostos neste momento
